...
JPX reduced the TOPIX weight of each Phase Transitional Stock over **eight quarterly steps**, ending in January 2025. At each quarterly step, JPX cut **1/8** of the company's original transition weight. By step 8, the company had zero weight and left the index.
...
| selected universe | TOPIX reform changed how the index selects companies from the listed universe. | It shows that the index now chooses rather than automatically includes. |
| market-segment membership | Whether a company is listed in Prime, Standard or Growth. | It turns a technical label into a concrete listing status. |
| tradable-share market cap | The market value of shares that investors can actually trade. | It defines the measure by the shares included in it. |
| Phase Transitional Stock | A company that would not disappear from TOPIX immediately, but whose weight would fall step by step. | It explains the consequence of the label. |
| passive flows | Trades made by funds that track an index instead of choosing each company one by one. | It identifies who trades and why they trade. |
| tracking error | A fund's portfolio no longer matches the index it promised to follow. | It explains the risk for index funds in plain terms. |
| automatic TOPIX inclusion | A company enters TOPIX because of its listing label. | It makes the old rule visible. |
| annual trading-value turnover ratio | The yen value of shares traded in one year divided by free-float market cap. | It explains the calculation before using the threshold. |
| cumulative free-float market cap | JPX adds freely tradable market values from the largest company downward. | It turns the noun stack into a step-by-step ranking process. |
| free-float weight | How much of the index sits in shares that investors can actually trade. | It explains the weight concept through index exposure. |
| circulation test | Whether freely tradable shares actually trade. | It connects the shorthand to investor usability. |
| size test | Whether the value of freely tradable shares is large enough. | It states what the test measures. |
| passive demand | Buying from funds that must hold a stock because the stock is in an index. | It explains the source of demand. |
| index-transition tool | A standard tool for moving from old index rules to new index rules without one large trading event. | It explains the policy function instead of naming the tool first. |

### Causal-chain unpacking check

| Original logic-packed wording | Hidden logic | Rewritten explanation |
| ----------------------------- | ------------ | --------------------- |
| TOPIX reform belongs with segment reform. | Segment labels and index membership were tied together, so changing only one leaves the old incentive partly intact. | Segment reform creates Prime, Standard, and Growth. TOPIX reform then changes how the index selects from that listed universe. |
| The old rule rewarded 1st-Section entry. | TOPIX followed the 1st Section, and TOPIX-linked funds usually had to buy every constituent. | Once a company entered the 1st Section, TOPIX-linked funds usually had to buy it. |
| Phase 1 reduced TOPIX along the tradable-share-market-cap dimension. | JPX targeted companies whose freely tradable market value was below JPY 10 bn. | Phase 1 mainly removed companies whose tradable market value was too small. |
| Gradual reduction limited passive-flow pressure. | Index funds sell when index weights fall; spreading cuts reduces one-time selling. | JPX cut weights over eight steps so many funds did not need to sell the same shares at once. |
| Phase 2 separates TOPIX from market labels. | Prime, Standard, and Growth still define listing rules, but no longer decide TOPIX membership. | The market label says which listing rules apply. TOPIX membership says whether index funds need to hold the shares. |
| Liquidity becomes central. | A company can be large on paper but hard to trade if few shares change hands. | The turnover test checks whether 14% of free-float market cap trades in a year. |
| The Prime label alone no longer attracts passive demand. | TOPIX inclusion depends on free float and turnover, not only listing segment. | A Prime company and a Standard company with the same free float and trading activity are treated similarly for TOPIX demand. |
| The eight-step method is policy, not administration. | The schedule changes how market participants absorb index reform. | It spreads selling pressure, gives investors predictability, and gives issuers time to respond. |
| IR teams must explain two facts. | Segment status and TOPIX status can now diverge. | Companies need to explain both their market label and whether TOPIX-linked funds need to own them. |
...
- All dates were preserved. These include 2021, 2022, October 2022, January 2025, February 2025, September 2026, October 2026, July 2028, 2024, July 2024, and 27 Dec 2019.
- All numerical thresholds were preserved. These include JPY 10 bn, 0.14, 14%, top 97%, smallest 3%, 1/8, eight quarterly steps, 27 months, the 20-month interim period, 60%, about one third, 60% founder holding, and bottom 50–100 names by float.
- All constituent counts were preserved. These include about 2,200 at peak and in 2021, about 2,100 in October 2022, about 1,700 in January 2025 and the interim period, about 1,200 by July 2028, about 400 removed, about 19% reduction, and about 45% reduction from peak.
- All source references were preserved. These include JPX TOPIX (TPX), JPX Overview of Revisions of TOPIX and Other Indices PDF (2024), JPX Second stage of revisions, JPX Revisions of TOPIX, the FSA 27 Dec 2019 *Reiwa* report, and the Sumitomo Mitsui DS AM article.
- No new unsupported claims were added. Where the article discusses future JPX use of the eight-step method, the rewrite keeps it as an inference from Phase 1 and Phase 2 rather than as a disclosed fact.
